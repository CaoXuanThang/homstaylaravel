                                ...
                                <div class="property-item">
                                    ...
                                    <div class="property-content">
                                        ...
                                        <div>
                                            ...
                                            <a href="{{route('property',$item->id)}}" class="btn btn-primary py-2 px-3">See details</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
            <div class="property-item mb-30">
              <a href="property-single.html" class="img">
                <img src="{{ $item->image ? '' . Storage::url($item->image) : '' }}" alt="Image" class="img-fluid" style="width: 200px; height: 200px;" />
              </a>
              <div class="property-content">
                <div class="price mb-2"><span>{{$item->price}}</span></div>
                <div>
