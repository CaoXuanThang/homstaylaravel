    ...
    <div class="container">
      <div class="row justify-content-between mb-5">
        <div class="col-lg-7 mb-5 mb-lg-0">
          <div class="img-about dots">
            <img src="{{asset('asset/images/hero_bg_2.jpg')}}" alt="Image" class="img-fluid" />
          </div>
        </div>
        <div class="col-lg-4">
          <div class="d-flex feature-h">
        ...
        <div class="testimonial-slider">
          ...
          <div class="item">
            <div class="testimonial">
              ...
              />
              <h3 class="h5 text-primary">{{$item->name}}</h3>
              ...
              <ul class="social list-unstyled list-inline dark-hover">
                <li class="list-inline-item">
                  <a href="{{$item->twitter}}"><span class="icon-twitter"></span></a>
                </li>
                <li class="list-inline-item">
                  <a href="{{$item->facebook}}"><span class="icon-facebook"></span></a>
                </li>
                <li class="list-inline-item">
                  <a href="{{$item->instagram}}"><span class="icon-instagram"></span></a>
                </li>
              </ul>
            </div>
          </div>
