                ...
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                      ...
                      <div class="navbar-nav w-100 ps-2">
                        ...
                        <a href="{{ route('real_estate_category.list') }}" class="nav-item nav-link active"><i class="fa fa-laptop me-2"></i>Real category</a>
    ...
    <div class="row">
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded h-100 p-4">
                ...
                <form action="{{ route('real_estate_category.create') }}" method="POST">
                    @csrf
                    <div class="mb-3">
