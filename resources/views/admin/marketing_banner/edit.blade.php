        ...
        <div class="row">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('marketing_banner.update',$marketing_banner->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    <div class="col-xs-6">
                                        <img id="mat_truoc_preview"
                                            src="{{$marketing_banner->image ? Storage::url($marketing_banner->image) : ''}}"
