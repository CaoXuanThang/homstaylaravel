            ...
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                  ...
                  <div class="navbar-nav w-100 ps-2">
                    ...
                    <a href="{{ route('new.list') }}" class="nav-item nav-link active"><i class="fa-solid fa-newspaper me-2" style="color: #51371f;"></i> New</a>
    ...
    <div class="row">
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded h-100 p-4">
                <h6 class="mb-4">Sửa loại Tin tức</h6>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <img id="mat_truoc_preview"
                                        src="{{ $new->image ? '' . Storage::url($new->image) : '' }}"
