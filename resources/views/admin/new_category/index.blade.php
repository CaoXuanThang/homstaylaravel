    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="{{ route('new_category.list') }}" class="nav-item nav-link active"><i
                        class="fa fa-keyboard me-2"></i>New Category</a>
...
@endsection
@section('content')
    <a href="{{ route('new_category.show') }}" class="btn btn-primary">Add</a>
        ...
        <tbody>
            @foreach ($new_categories as $item)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('new_category.showupdate', $item->id) }}"><button type="button"
                                class="btn btn-primary">Edit</button></a>
                        <a href="{{ route('new_category.delete', $item->id) }}"><button type="button"
