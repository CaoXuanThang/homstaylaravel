                ...
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('designer.update',$designer->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <img id="mat_truoc_preview"
                                        src="{{$designer->image ? Storage::url($designer->image) : ''}}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="email" value="{{$designer->email}}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Phone</label>
                            <input type="text" class="form-control" name="phone" value="{{$designer->phone}}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Description</label>
                            <textarea class="form-control" name="description" >{{$designer->description}}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Facebook</label>
                            <input type="url" class="form-control" name="facebook" value="{{$designer->facebook}}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Twitter</label>
                            <input type="url" class="form-control" name="twitter" value="{{$designer->twitter}}">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Instagram</label>
                            <input type="url" class="form-control" name="instagram" value="{{$designer->instagram}}">
                        </div>
