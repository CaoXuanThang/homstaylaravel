    ...
    <div class="row">
        <div class="col-sm-12 col-xl-12">
            <div class="bg-light rounded h-100 p-4">
                ...
                <form action="{{ route('real_estate.update',$real_estate->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="description" value="{{$real_estate->description}}">
                    </div>
                    <div class="mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" name='real_estate_category_id'>
                        <option selected value="{{$real_estate->real_estate_category_id}}">{{$real_estate->real_estate_category->name}}</option>
